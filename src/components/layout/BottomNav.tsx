...
import { ClipboardList, Fuel, LayoutDashboard, Navigation } from "lucide-react";
...
export const BottomNav = memo(({ activeTab, setActiveTab, hasActiveJob }: BottomNavProps) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t flex justify-around p-2 pb-6 z-50 shadow-lg">
      {[
        ...
        const isDisabled = (isJobsTab && hasActiveJob) || (isActiveJobTab && !hasActiveJob);
