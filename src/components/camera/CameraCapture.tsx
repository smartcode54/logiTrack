...
import { detectBlur, BLUR_THRESHOLD } from "@/utils/blurDetection";
...
export const CameraCapture = memo(
  ({
    onCapture,
    onClose,
    label,
      ...
      <div className="fixed inset-0 z-[100] bg-black flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-4">
          {error ? (
            ...
            <>
              <div className="bg-yellow-500 text-white p-4 rounded-xl text-center space-y-3 mb-4">
              ...
              <div className="relative w-full h-full bg-black rounded-xl overflow-hidden border-4 border-yellow-500 mb-4">
                <img
                  src={capturedImage}
                  alt="Captured"
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="bg-black/70 text-white px-4 py-2 rounded-lg font-black">
                    ภาพเบลอ
                  </div>
                </div>
              </div>
              <div className="flex gap-4 w-full">
                ...
                <button
                  ...
                  className="flex-1 bg-yellow-600 text-white font-black py-4 rounded-xl flex items-center justify-center gap-2"
                >
                  <Camera size={24} />
                  ถ่ายใหม่
                </button>
                <button
                  onClick={handleUseBlurryImage}
                  className="flex-1 bg-gray-500 text-white font-black py-4 rounded-xl"
                >
                  ใช้ภาพนี้
                </button>
              </div>
